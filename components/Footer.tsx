        ...
        <footer className=" dark:text-white py-10 mt-20">
            <div className="container mx-auto px-6 lg:px-20">
                <div className="flex flex-wrap justify-between">
                    ...
                    <div data-aos="fade-up" className="w-full justify-center flex flex-col border-b border-t p-3 text-center mb-6 lg:mb-0">
                        <div className="flex items-center justify-center">
                            <img data-aos="fade-up" src="/logo.png" height={100} width={100} alt="" className="dark:hidden" />
                            <img data-aos="fade-up" src="/logo-1.png" height={100} width={100} alt="" className="hidden dark:flex" />
                        </div>
                    ...
                    <div className="w-full lg:w-1/3 my-6 mt-[30px] lg:mb-0">
                        <h3 data-aos="fade-up" className="text-xl font-semibold mb-2 text-purple-600 dark:text-primary-light">Quick Links</h3>
                    ...
                    <div className="w-full mt-[30px] lg:w-1/3">
                        <h3 data-aos="fade-up" className="text-xl font-semibold mb-2 text-purple-600">Contact Me</h3>
